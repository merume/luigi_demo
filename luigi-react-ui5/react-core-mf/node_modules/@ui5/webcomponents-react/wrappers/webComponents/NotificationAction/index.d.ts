...
export interface NotificationActionPropTypes extends NotificationActionAttributes, Omit<CommonProps, 'onClick'> {
     ...
     */
    onClick?: (event: Ui5CustomEvent<NotificationActionDomRef, {
 ...
 */
declare const NotificationAction: import("react").ForwardRefExoticComponent<NotificationActionPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<NotificationActionDomRef>>;
