...
export interface BreadcrumbsPropTypes extends BreadcrumbsAttributes, CommonProps {
     ...
     */
    onItemClick?: (event: Ui5CustomEvent<BreadcrumbsDomRef, {
        item: HTMLElement;
        altKey: boolean;
        ctrlKey: boolean;
        metaKey: boolean;
 ...
 */
declare const Breadcrumbs: import("react").ForwardRefExoticComponent<BreadcrumbsPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<BreadcrumbsDomRef>>;
export { Breadcrumbs };
