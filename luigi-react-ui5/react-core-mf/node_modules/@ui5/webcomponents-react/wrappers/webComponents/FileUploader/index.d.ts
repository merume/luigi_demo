...
export interface FileUploaderPropTypes extends FileUploaderAttributes, Omit<CommonProps, 'onChange'> {
     ...
     */
    onChange?: (event: Ui5CustomEvent<FileUploaderDomRef, {
        files: FileList;
    }>) => void;
}
/**
 ...
 */
declare const FileUploader: import("react").ForwardRefExoticComponent<FileUploaderPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<FileUploaderDomRef>>;
export { FileUploader };
