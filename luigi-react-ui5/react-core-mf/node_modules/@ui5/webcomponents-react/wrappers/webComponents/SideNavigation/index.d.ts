...
export interface SideNavigationPropTypes extends SideNavigationAttributes, CommonProps {
     ...
     */
    onSelectionChange?: (event: Ui5CustomEvent<SideNavigationDomRef, {
        item: HTMLElement;
    }>) => void;
}
/**
 ...
 */
declare const SideNavigation: import("react").ForwardRefExoticComponent<SideNavigationPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<SideNavigationDomRef>>;
