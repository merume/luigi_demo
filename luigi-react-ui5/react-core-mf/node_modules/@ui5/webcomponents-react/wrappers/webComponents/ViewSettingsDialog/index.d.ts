...
export interface ViewSettingsDialogPropTypes extends ViewSettingsDialogAttributes, CommonProps {
     ...
     */
    onCancel?: (event: Ui5CustomEvent<ViewSettingsDialogDomRef, {
        sortOrder: string;
        sortBy: string;
     ...
     */
    onConfirm?: (event: Ui5CustomEvent<ViewSettingsDialogDomRef, {
        sortOrder: string;
        sortBy: string;
        sortByItem: HTMLElement;
        sortDescending: boolean;
 ...
 */
declare const ViewSettingsDialog: import("react").ForwardRefExoticComponent<ViewSettingsDialogPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<ViewSettingsDialogDomRef>>;
