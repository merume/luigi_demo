...
export interface MenuPropTypes extends MenuAttributes, CommonProps {
     ...
     */
    onBeforeClose?: (event: Ui5CustomEvent<MenuDomRef, {
        escPressed: boolean;
    }>) => void;
    /**
     ...
     */
    onItemClick?: (event: Ui5CustomEvent<MenuDomRef, {
 ...
 */
declare const Menu: import("react").ForwardRefExoticComponent<MenuPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<MenuDomRef>>;
export { Menu };
