...
export interface ResponsivePopoverPropTypes extends ResponsivePopoverAttributes, CommonProps {
     ...
     */
    onBeforeClose?: (event: Ui5CustomEvent<ResponsivePopoverDomRef, {
        escPressed: boolean;
    }>) => void;
    /**
 ...
 */
declare const ResponsivePopover: import("react").ForwardRefExoticComponent<ResponsivePopoverPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<ResponsivePopoverDomRef>>;
