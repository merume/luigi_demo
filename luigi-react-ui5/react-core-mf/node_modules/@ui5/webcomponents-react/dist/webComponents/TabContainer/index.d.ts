...
export interface TabContainerPropTypes extends TabContainerAttributes, CommonProps {
     ...
     */
    onTabSelect?: (event: Ui5CustomEvent<TabContainerDomRef, {
        tab: HTMLElement;
        tabIndex: number;
    }>) => void;
}
 ...
 */
declare const TabContainer: import("react").ForwardRefExoticComponent<TabContainerPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<TabContainerDomRef>>;
export { TabContainer };
