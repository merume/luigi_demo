...
export interface DynamicSideContentPropTypes extends DynamicSideContentAttributes, CommonProps {
     ...
     */
    onLayoutChange?: (event: Ui5CustomEvent<DynamicSideContentDomRef, {
 ...
 */
declare const DynamicSideContent: import("react").ForwardRefExoticComponent<DynamicSideContentPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<DynamicSideContentDomRef>>;
