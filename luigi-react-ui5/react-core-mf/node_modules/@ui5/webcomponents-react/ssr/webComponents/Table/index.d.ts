...
export interface TablePropTypes extends TableAttributes, CommonProps {
     ...
     */
    onPopinChange?: (event: Ui5CustomEvent<TableDomRef, {
        poppedColumns: unknown[];
    }>) => void;
    /**
     * Fired when a row in `Active` mode is clicked or `Enter` key is pressed.
     */
    onRowClick?: (event: Ui5CustomEvent<TableDomRef, {
        row: HTMLElement;
    }>) => void;
    /**
     * Fired when selection is changed by user interaction in `SingleSelect` and `MultiSelect` modes.
     */
    onSelectionChange?: (event: Ui5CustomEvent<TableDomRef, {
 ...
 */
declare const Table: import("react").ForwardRefExoticComponent<TablePropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<TableDomRef>>;
export { Table };
