...
export interface ShellBarPropTypes extends ShellBarAttributes, CommonProps {
     ...
     */
    onCoPilotClick?: (event: Ui5CustomEvent<ShellBarDomRef, {
        targetRef: HTMLElement;
    }>) => void;
    /**
     * Fired, when the logo is activated.
     */
    onLogoClick?: (event: Ui5CustomEvent<ShellBarDomRef, {
        targetRef: HTMLElement;
    }>) => void;
    /**
     * Fired, when a menu item is activated **Note:** You can prevent closing of overflow popover by calling `event.preventDefault()`.
     */
    onMenuItemClick?: (event: Ui5CustomEvent<ShellBarDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     * Fired, when the notification icon is activated.
     */
    onNotificationsClick?: (event: Ui5CustomEvent<ShellBarDomRef, {
        targetRef: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onProductSwitchClick?: (event: Ui5CustomEvent<ShellBarDomRef, {
        targetRef: HTMLElement;
    }>) => void;
    /**
     * Fired, when the profile slot is present.
     */
    onProfileClick?: (event: Ui5CustomEvent<ShellBarDomRef, {
        targetRef: HTMLElement;
    }>) => void;
}
/**
 ...
 */
declare const ShellBar: import("react").ForwardRefExoticComponent<ShellBarPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<ShellBarDomRef>>;
export { ShellBar };
