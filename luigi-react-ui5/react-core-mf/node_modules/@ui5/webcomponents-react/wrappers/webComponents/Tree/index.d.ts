...
export interface TreePropTypes extends TreeAttributes, CommonProps {
     ...
     */
    onItemClick?: (event: Ui5CustomEvent<TreeDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onItemDelete?: (event: Ui5CustomEvent<TreeDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     * Fired when the mouse cursor leaves the tree item borders.
     */
    onItemMouseout?: (event: Ui5CustomEvent<TreeDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     * Fired when the mouse cursor enters the tree item borders.
     */
    onItemMouseover?: (event: Ui5CustomEvent<TreeDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onItemToggle?: (event: Ui5CustomEvent<TreeDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onSelectionChange?: (event: Ui5CustomEvent<TreeDomRef, {
 ...
 */
declare const Tree: import("react").ForwardRefExoticComponent<TreePropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<TreeDomRef>>;
export { Tree };
