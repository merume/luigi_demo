...
export interface CalendarPropTypes extends CalendarAttributes, CommonProps {
     ...
     */
    onSelectedDatesChange?: (event: Ui5CustomEvent<CalendarDomRef, {
        values: unknown[];
        dates: unknown[];
    }>) => void;
}
 ...
 */
declare const Calendar: import("react").ForwardRefExoticComponent<CalendarPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<CalendarDomRef>>;
export { Calendar };
