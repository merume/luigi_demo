...
let DatePicker = DatePicker_1 = class DatePicker extends DateComponentBase {
    ...
    get dateValue() {
        ...
        return this.liveValue ? this.getFormat().parse(this.liveValue, utc, strict) : this.getFormat().parse(this.value, utc, strict);
    }
    get dateValueUTC() {
        const utc = undefined;
        const strict = undefined;
        return this.liveValue ? this.getFormat().parse(this.liveValue, true, strict) : this.getFormat().parse(this.value, utc, strict);
    }
    get styles() {
        return {
            main: {
