...
export interface TimePickerPropTypes extends TimePickerAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onChange?: (event: Ui5CustomEvent<TimePickerDomRef, {
        value: string;
        valid: boolean;
    }>) => void;
    /**
     ...
     */
    onInput?: (event: Ui5CustomEvent<TimePickerDomRef, {
        value: string;
        valid: boolean;
    }>) => void;
}
 ...
 */
declare const TimePicker: import("react").ForwardRefExoticComponent<TimePickerPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<TimePickerDomRef>>;
export { TimePicker };
