...
export interface ColorPalettePropTypes extends ColorPaletteAttributes, CommonProps {
     ...
     */
    onItemClick?: (event: Ui5CustomEvent<ColorPaletteDomRef, {
        color: string;
    }>) => void;
}
/**
 ...
 */
declare const ColorPalette: import("react").ForwardRefExoticComponent<ColorPalettePropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<ColorPaletteDomRef>>;
export { ColorPalette };
