 ...
 */
const Button = withWebComponent('ui5-button', ['accessibleName', 'accessibleNameRef', 'design', 'icon', 'tooltip'], ['disabled', 'iconEnd', 'submits'], [], ['click'], () => import('@ui5/webcomponents/dist/Button.js'));
