...
let DateRangePicker = DateRangePicker_1 = class DateRangePicker extends DatePicker {
    ...
    get _tempTimestamp() {
        return this._tempValue && this.getFormat().parse(this._tempValue, true, undefined).getTime() / 1000;
    }
    /**
    ...
    _splitValueByDelimiter(value) {
        ...
        if (this.getFormat().parse(value, undefined, undefined)) {
    ...
    _extractFirstTimestamp(value) {
        ...
        const parsedDate = this.getFormat().parse(dateStrings[0], true, undefined);
    ...
    _extractLastTimestamp(value) {
        ...
        if (dateStrings[1]) {
            const parsedDate = this.getFormat().parse(dateStrings[1], true, undefined);
            return parsedDate.getTime() / 1000;
        }
        return undefined;
    }
