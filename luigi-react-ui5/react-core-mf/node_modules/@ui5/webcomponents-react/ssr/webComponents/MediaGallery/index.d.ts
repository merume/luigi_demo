...
export interface MediaGalleryPropTypes extends MediaGalleryAttributes, CommonProps {
     ...
     */
    onSelectionChange?: (event: Ui5CustomEvent<MediaGalleryDomRef, {
        item: HTMLElement;
    }>) => void;
}
/**
 ...
 */
declare const MediaGallery: import("react").ForwardRefExoticComponent<MediaGalleryPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<MediaGalleryDomRef>>;
export { MediaGallery };
