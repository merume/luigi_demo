...
export interface DialogPropTypes extends DialogAttributes, Omit<CommonProps, 'draggable'> {
     ...
     */
    onBeforeClose?: (event: Ui5CustomEvent<DialogDomRef, {
        escPressed: boolean;
    }>) => void;
    /**
 ...
 */
declare const Dialog: import("react").ForwardRefExoticComponent<DialogPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<DialogDomRef>>;
export { Dialog };
