...
export interface DatePickerPropTypes extends DatePickerAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onChange?: (event: Ui5CustomEvent<DatePickerDomRef, {
        value: string;
        valid: boolean;
    }>) => void;
    /**
     ...
     */
    onInput?: (event: Ui5CustomEvent<DatePickerDomRef, {
        value: string;
        valid: boolean;
    }>) => void;
}
 ...
 */
declare const DatePicker: import("react").ForwardRefExoticComponent<DatePickerPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<DatePickerDomRef>>;
export { DatePicker };
