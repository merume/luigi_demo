...
const block4 = (context, tags, suffix) => suffix ? html`<div @click=${context._clear} @mousedown=${context._iconMouseDown} class="ui5-input-clear-icon-wrapper" input-icon tabindex="-1"><${scopeTag("ui5-icon", tags, suffix)} tabindex="-1" class="ui5-input-clear-icon" name="decline"></${scopeTag("ui5-icon", tags, suffix)}></div>` : html`<div @click=${context._clear} @mousedown=${context._iconMouseDown} class="ui5-input-clear-icon-wrapper" input-icon tabindex="-1"><ui5-icon tabindex="-1" class="ui5-input-clear-icon" name="decline"></ui5-icon></div>`;
