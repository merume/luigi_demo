...
export interface SelectPropTypes extends SelectAttributes, Omit<CommonProps, 'onChange'> {
     ...
     */
    onChange?: (event: Ui5CustomEvent<SelectDomRef, {
 ...
 */
declare const Select: import("react").ForwardRefExoticComponent<SelectPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<SelectDomRef>>;
export { Select };
