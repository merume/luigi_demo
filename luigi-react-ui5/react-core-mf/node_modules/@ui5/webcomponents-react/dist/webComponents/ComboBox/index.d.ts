...
export interface ComboBoxPropTypes extends ComboBoxAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onSelectionChange?: (event: Ui5CustomEvent<ComboBoxDomRef, {
        item: HTMLElement;
    }>) => void;
}
/**
 ...
 */
declare const ComboBox: import("react").ForwardRefExoticComponent<ComboBoxPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<ComboBoxDomRef>>;
export { ComboBox };
