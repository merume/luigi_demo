...
export interface DateRangePickerPropTypes extends DateRangePickerAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onChange?: (event: Ui5CustomEvent<DateRangePickerDomRef, {
        value: string;
        valid: boolean;
    }>) => void;
    /**
     ...
     */
    onInput?: (event: Ui5CustomEvent<DateRangePickerDomRef, {
        value: string;
        valid: boolean;
    }>) => void;
}
 ...
 */
declare const DateRangePicker: import("react").ForwardRefExoticComponent<DateRangePickerPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<DateRangePickerDomRef>>;
