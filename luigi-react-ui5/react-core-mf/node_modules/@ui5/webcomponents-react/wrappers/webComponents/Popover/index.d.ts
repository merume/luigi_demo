...
export interface PopoverPropTypes extends PopoverAttributes, CommonProps {
     ...
     */
    onBeforeClose?: (event: Ui5CustomEvent<PopoverDomRef, {
        escPressed: boolean;
    }>) => void;
    /**
 ...
 */
declare const Popover: import("react").ForwardRefExoticComponent<PopoverPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<PopoverDomRef>>;
export { Popover };
