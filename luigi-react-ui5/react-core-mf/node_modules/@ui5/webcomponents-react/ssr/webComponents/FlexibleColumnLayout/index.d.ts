...
export interface FlexibleColumnLayoutPropTypes extends FlexibleColumnLayoutAttributes, CommonProps {
     ...
     */
    onLayoutChange?: (event: Ui5CustomEvent<FlexibleColumnLayoutDomRef, {
        layout: FCLLayout | keyof typeof FCLLayout;
 ...
 */
declare const FlexibleColumnLayout: import("react").ForwardRefExoticComponent<FlexibleColumnLayoutPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<FlexibleColumnLayoutDomRef>>;
