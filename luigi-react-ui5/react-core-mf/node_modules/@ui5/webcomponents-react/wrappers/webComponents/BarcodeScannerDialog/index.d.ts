...
export interface BarcodeScannerDialogPropTypes extends BarcodeScannerDialogAttributes, CommonProps {
     ...
     */
    onScanError?: (event: Ui5CustomEvent<BarcodeScannerDialogDomRef, {
        message: string;
    }>) => void;
    /**
     * Fires when the scan is completed successfuuly.
     */
    onScanSuccess?: (event: Ui5CustomEvent<BarcodeScannerDialogDomRef, {
        text: string;
        rawBytes: Record<string, unknown>;
    }>) => void;
}
/**
 ...
 */
declare const BarcodeScannerDialog: import("react").ForwardRefExoticComponent<BarcodeScannerDialogPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<BarcodeScannerDialogDomRef>>;
