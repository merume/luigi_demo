...
export interface MultiComboBoxPropTypes extends MultiComboBoxAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onSelectionChange?: (event: Ui5CustomEvent<MultiComboBoxDomRef, {
        items: unknown[];
    }>) => void;
}
/**
 ...
 */
declare const MultiComboBox: import("react").ForwardRefExoticComponent<MultiComboBoxPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<MultiComboBoxDomRef>>;
