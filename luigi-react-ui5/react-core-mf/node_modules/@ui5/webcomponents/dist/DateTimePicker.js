...
let DateTimePicker = DateTimePicker_1 = class DateTimePicker extends DatePicker {
    ...
    getSelectedDateTime() {
        const selectedDate = this.getFormat().parse(this._calendarSelectedDates[0], undefined, undefined);
        const selectedTime = this.getFormat().parse(this._timeSelectionValue, undefined, undefined);
        if (selectedTime) {
