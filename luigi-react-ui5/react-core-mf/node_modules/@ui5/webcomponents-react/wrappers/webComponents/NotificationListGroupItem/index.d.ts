...
export interface NotificationListGroupItemPropTypes extends NotificationListGroupItemAttributes, CommonProps {
     ...
     */
    onClose?: (event: Ui5CustomEvent<NotificationListGroupItemDomRef, {
        item: HTMLElement;
    }>) => void;
}
/**
 ...
 */
declare const NotificationListGroupItem: import("react").ForwardRefExoticComponent<NotificationListGroupItemPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<NotificationListGroupItemDomRef>>;
