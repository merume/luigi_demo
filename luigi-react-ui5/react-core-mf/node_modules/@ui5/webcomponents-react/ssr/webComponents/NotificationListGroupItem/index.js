 ...
 */
const NotificationListGroupItem = withWebComponent('ui5-li-notification-group', ['busyDelay', 'priority', 'titleText'], ['collapsed', 'showCounter', 'busy', 'read', 'showClose', 'selected'], ['actions'], ['toggle', 'close'], () => import('@ui5/webcomponents-fiori/dist/NotificationListGroupItem.js'));
