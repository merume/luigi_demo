...
export interface MultiInputPropTypes extends MultiInputAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onTokenDelete?: (event: Ui5CustomEvent<MultiInputDomRef, {
        token: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onSuggestionItemPreview?: (event: Ui5CustomEvent<MultiInputDomRef, {
        item: HTMLElement;
     ...
     */
    onSuggestionItemSelect?: (event: Ui5CustomEvent<MultiInputDomRef, {
        item: HTMLElement;
    }>) => void;
}
/**
 ...
 */
declare const MultiInput: import("react").ForwardRefExoticComponent<MultiInputPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<MultiInputDomRef>>;
export { MultiInput };
