...
export interface DateTimePickerPropTypes extends DateTimePickerAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onChange?: (event: Ui5CustomEvent<DateTimePickerDomRef, {
        value: string;
        valid: boolean;
    }>) => void;
    /**
     ...
     */
    onInput?: (event: Ui5CustomEvent<DateTimePickerDomRef, {
        value: string;
        valid: boolean;
    }>) => void;
}
 ...
 */
declare const DateTimePicker: import("react").ForwardRefExoticComponent<DateTimePickerPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<DateTimePickerDomRef>>;
