...
export interface UploadCollectionPropTypes extends UploadCollectionAttributes, Omit<CommonProps, 'onDrop'> {
     ...
     */
    onItemDelete?: (event: Ui5CustomEvent<UploadCollectionDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     * Fired when selection is changed by user interaction in `SingleSelect` and `MultiSelect` modes.
     */
    onSelectionChange?: (event: Ui5CustomEvent<UploadCollectionDomRef, {
 ...
 */
declare const UploadCollection: import("react").ForwardRefExoticComponent<UploadCollectionPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<UploadCollectionDomRef>>;
