...
export interface ListPropTypes extends ListAttributes, CommonProps {
     ...
     */
    onItemClick?: (event: Ui5CustomEvent<ListDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onItemClose?: (event: Ui5CustomEvent<ListDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onItemDelete?: (event: Ui5CustomEvent<ListDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onItemToggle?: (event: Ui5CustomEvent<ListDomRef, {
        item: HTMLElement;
    }>) => void;
    /**
     ...
     */
    onSelectionChange?: (event: Ui5CustomEvent<ListDomRef, {
 ...
 */
declare const List: import("react").ForwardRefExoticComponent<ListPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<ListDomRef>>;
export { List };
