...
export interface ColorPalettePopoverPropTypes extends ColorPalettePopoverAttributes, CommonProps {
     ...
     */
    onItemClick?: (event: Ui5CustomEvent<ColorPalettePopoverDomRef, {
        color: string;
    }>) => void;
}
/**
 ...
 */
declare const ColorPalettePopover: import("react").ForwardRefExoticComponent<ColorPalettePopoverPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<ColorPalettePopoverDomRef>>;
