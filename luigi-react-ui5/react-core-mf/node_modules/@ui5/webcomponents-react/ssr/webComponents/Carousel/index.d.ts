...
export interface CarouselPropTypes extends CarouselAttributes, CommonProps {
     ...
     */
    onNavigate?: (event: Ui5CustomEvent<CarouselDomRef, {
 ...
 */
declare const Carousel: import("react").ForwardRefExoticComponent<CarouselPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<CarouselDomRef>>;
export { Carousel };
