...
export interface LinkPropTypes extends LinkAttributes, Omit<CommonProps, 'onClick'> {
     ...
     */
    onClick?: (event: Ui5CustomEvent<LinkDomRef, {
        altKey: boolean;
        ctrlKey: boolean;
        metaKey: boolean;
        shiftKey: boolean;
 ...
 */
declare const Link: import("react").ForwardRefExoticComponent<LinkPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<LinkDomRef>>;
export { Link };
