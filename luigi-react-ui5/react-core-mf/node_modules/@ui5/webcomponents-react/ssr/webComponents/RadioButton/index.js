 ...
 */
const RadioButton = withWebComponent('ui5-radio-button', ['accessibleName', 'accessibleNameRef', 'name', 'text', 'value', 'valueState', 'wrappingType'], ['checked', 'disabled', 'readonly', 'required'], [], ['change'], () => import('@ui5/webcomponents/dist/RadioButton.js'));
