...
export interface InputPropTypes extends InputAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onSuggestionItemPreview?: (event: Ui5CustomEvent<InputDomRef, {
        item: HTMLElement;
     ...
     */
    onSuggestionItemSelect?: (event: Ui5CustomEvent<InputDomRef, {
        item: HTMLElement;
    }>) => void;
}
/**
 ...
 */
declare const Input: import("react").ForwardRefExoticComponent<InputPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<InputDomRef>>;
export { Input };
